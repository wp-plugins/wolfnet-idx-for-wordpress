...
this.beenWarned=!0)};return this.each(function(){var c=d(this),e=c.find("tr.basic-option,tr.advanced-option"),h=c.find(".modeField input");e.hide();h.each(function(){this.$fields=e});h.click(a);h.bind("ready",a);d(document).ready(function(){h.trigger("ready")});c=c.find(".savedSearchField select:first");"deleted"==c.val()&&(c.each(function(){this.beenWarned=!1}),c.click(b),c.focus(b))})};d.fn.wolfnetValidateProductKey=function(e){var a={validClass:"valid",invalidClass:"invalid",wrapperClass:"wolfnetProductKeyValidationWrapper",
validEvent:"validProductKey",invalidEvent:"invalidProductKey",validationEvent:"validateProductKey",apiUri:"http://services.mlsfinder.com/v1/validateKey/"};d.extend(a,e);var b=function(f){var b=d(f),f=b.val();d.ajax({url:a.apiUri+f+".jsonp",dataType:"jsonp",type:"GET",cache:!1,timeout:2500,statusCode:{404:function(){console.log("404");commFailure()}},success:function(d){d.error.status?!0===d.error.status&&"Product Key is Disabled"==d.error.message?(b.trigger(a.invalidEvent),alert("The product key you have entered is currently disabled. Please contact customer services for more information.")):
b.trigger(a.invalidEvent):b.trigger(a.validEvent)},error:function(){b.trigger(a.invalidEvent);alert("Your product key appears to be formated correctly but we are unable to validate it against our servers at this time.")}})},c=function(){var f=d(this),c=f.parent(),e=f.val();if(""!=e){c="wp_"==e.substring(0,3).toLowerCase()?!0:!1;if(c=!0===c)e=35==e.length?!0:!1,c=!0===e;c?(f.trigger(a.validEvent),b(this)):f.trigger(a.invalidEvent)}else c.removeClass(a.validClass),c.removeClass(a.invalidClass)},g=function(){var c=
d(this).parent();c.addClass(a.validClass);c.removeClass(a.invalidClass)},h=function(){var c=d(this).parent();c.addClass(a.invalidClass);c.removeClass(a.validClass)};return this.each(function(){var b=d(this);if("input"!=this.nodeName.toLowerCase())throw"wolfnetValidateProductKey jQuery plugin can only be applied to an input element!";var e=d("<span/>");e.addClass(a.wrapperClass);b.after(e);b.appendTo(e);b.bind(a.validationEvent,c);b.bind(a.validEvent,g);b.bind(a.invalidEvent,h);b.keyup(function(){b.trigger(a.validationEvent)});
d(document).ready(function(){b.trigger(a.validationEvent)})})}}(jQuery);
