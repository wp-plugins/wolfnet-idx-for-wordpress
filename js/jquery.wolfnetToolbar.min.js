...
'">');e=e+('<div class="wolfnet_wntHouseOverWrapper"><div data-property-id="'+h.property_id);e=e+'" class="wntHOItem"><table class="wolfnet_wntHOTable"><tbody><tr>';e=e+'<td class="wntHOImgCol" valign="top" style="vertical-align:top;"><div class="wolfnet_wntHOImg">';e=e+('<img src="'+h.thumbnail_url+'" style="max-height:100px;width:auto"></div><div class="wolfnet_wntHOBroker" style="text-align: center">');e=e+('<img class="wolfnet_wntHOBrokerLogo" src="'+h.branding.brokerLogo+'" style="max-height:50px;width:auto" alt="Broker Reciprocity">');
