...
b.bind(a.option.savedEvent,function(){if(e.length!=0){e.val("");e.trigger("blur")}c(this).data("wolfnetSearchManager",c.extend(a,{saving:false}))});b.bind(a.option.deletedEvent,function(){b.data("wolfnetSearchManager",c.extend(a,{deleting:false}))})})},refresh:function(){return this.each(function(){c(this).wolfnetSearchManager("_loadData")})},save:function(d,b){if(typeof d!="string"||typeof b!="object"){c.error("To perform save on jQuery.wolfnetSearchManager valid description and criteria arguments must be passed.");
