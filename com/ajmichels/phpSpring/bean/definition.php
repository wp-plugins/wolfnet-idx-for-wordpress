...
/**
 * @package       com.ajmichels.phpSpring.bean
 ...
 */
class com_ajmichels_phpSpring_bean_definition
extends com_ajmichels_common_abstractClass
{
	 ...
	 * @type com_ajmichels_phpSpring_bean_factory_iFactory
	 */
	private $beanFactory;
	...
	public function __construct ( com_ajmichels_phpSpring_bean_factory_iFactory &$beanFactory )
	{
		...
		try {
			...
			if ( $this->isSingleton() ) {
				if ( $this->beanInstance == null ) {
					if ( array_search( 'com_ajmichels_common_iSingleton', $ref->getInterfaceNames() ) !== false ) {
	...
	public function setBeanFactory ( com_ajmichels_phpSpring_bean_factory_iFactory &$beanFactory )
	{
	...
	public function addProperty ( com_ajmichels_phpSpring_bean_property $property )
	{
