...
/**
 * This class is a specific bean factory implementation ({@see com_ajmichels_phpSpring_bean_factory_aFactory}}) 
 ...
 * @version       1.0
 * @extends      com_ajmichels_phpSpring_bean_factory_aFactory
 * @implements   com_ajmichels_phpSpring_bean_factory_iFactory
 ...
 *
 */
class com_ajmichels_phpSpring_bean_factory_default
extends com_ajmichels_phpSpring_bean_factory_aFactory
implements com_ajmichels_phpSpring_bean_factory_iFactory
{
	...
	/**
	 * This method takes in a reference to a newly created Bean Definition ({@see com_ajmichels_phpSpring_bean_definition}}),
	 ...
	 *
	 * @param   com_ajmichels_phpSpring_bean_definition  $beanDefinition  A simpleXml object containing configuration data for a bean.
	 * @param   array  $childrenXml  An array of simpleXml object containing configuration data 
	 *                               for a bean property.
	 * @return  void
	 */
	private function parseBeanChildren (	com_ajmichels_phpSpring_bean_definition &$beanDefinition, 
											$childrenXml )
	{
	 ...
	 * creates a new Property Definition object ({@see com_ajmichels_phpSpring_bean_property}})
	 *
	 * @param   com_ajmichels_phpSpring_bean_definition  $beanDefinition  A simpleXml object containing configuration data for a bean.
	 ...
	 * @return  void
	 */
	private function parsePropertyDefinition (	com_ajmichels_phpSpring_bean_definition &$beanDefinition, 
	...
	/**
	 * This method takes in a reference to a newly created Property Definition ({@see com_ajmichels_phpSpring_bean_definition}}),
	 ...
	 * @return  void
	 */
	private function parseChildNode (	com_ajmichels_phpSpring_bean_property &$propertyDefinition, 
	 ...
	 * 
	 * @param  com_ajmichels_phpSpring_bean_property  $propertyDefinition
	 * @param  array   $mapEntries
	 * @param  string  $returnType
	 * @param  array   $properties
	 */
	private function parseEntries (	com_ajmichels_phpSpring_bean_property &$propertyDefinition, 
		...
		foreach ( $mapEntries as &$entry ) {
			...
			switch ( $entryChild->getName() ) { 
				...
				case 'ref':
					...
					$rtn[$entryKey] = new com_ajmichels_phpSpring_bean_reference( $entryBeanID );
