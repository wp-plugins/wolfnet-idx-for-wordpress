...
if ( !class_exists( 'com_ajmichels_wppf_filter_manager' ) ) {

/**
 * @package       com.ajmichels.wppf.filter
 * @title         manager.php
...
class com_ajmichels_wppf_filter_manager
extends com_ajmichels_wppf_abstract_hookManager
implements com_ajmichels_common_iSingleton
{
	...
	public function register ( com_ajmichels_wppf_filter_filter $obj, $hooks )
	{
