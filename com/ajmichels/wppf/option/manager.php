...
if ( !class_exists( 'com_ajmichels_wppf_option_manager' ) ) {

/**
 * @package       com.ajmichels.wppf.option
 * @title         manager.php
...
class com_ajmichels_wppf_option_manager
extends com_ajmichels_wppf_abstract_manager
implements com_ajmichels_common_iSingleton
{
	...
	public function register ( $option, $default = false )
	{
		...
		if ( $this->canRegister ) {
			...
			elseif ( $option instanceof com_ajmichels_wppf_interface_iOption ) {
	...
	public function registerWithWP ()
	{
		...
		if ( $this->canRegister ) {
			...
			foreach ( $options as $optionName => $option ) {
				...
				if ( $option instanceof com_ajmichels_wppf_interface_iOption ) {
