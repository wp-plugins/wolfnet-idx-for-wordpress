...
if ( !class_exists( 'com_ajmichels_common_abstractClass' ) ) {
...
abstract class com_ajmichels_common_abstractClass
{
	...
	private function initLogger ()
	{
		if ( !isset( $this->logger ) ) {
			$this->logger = com_ajmichels_common_logger::getInstance();
		}
	}
