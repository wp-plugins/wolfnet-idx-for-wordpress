...
if ( !class_exists( 'com_ajmichels_common_logger' ) ) {

/**
 * @package       com.ajmichels.common
 * @title         logger.php
...
class com_ajmichels_common_logger
{
	...
	private function __construct()
	{
		...
		$this->settings = new com_ajmichels_common_loggerSettings();
...
if ( !class_exists( 'com_ajmichels_common_loggerSettings' ) ) {

class com_ajmichels_common_loggerSettings
{
