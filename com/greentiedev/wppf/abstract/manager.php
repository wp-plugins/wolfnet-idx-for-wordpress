...
if ( !class_exists( 'com_greentiedev_wppf_abstract_manager' ) ) {
...
abstract class com_greentiedev_wppf_abstract_manager
extends com_greentiedev_phpCommon_abstractClass
{
	...
	public function register ( com_greentiedev_wppf_interface_iManaged &$obj )
	{
		if ( $this->getPlugin() != null ) {
			$obj->setPlugin( $this->getPlugin() );
		}
		array_push( $this->managed, $obj );
	}
