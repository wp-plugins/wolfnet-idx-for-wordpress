...
if ( !class_exists( 'com_greentiedev_wppf_abstract_view' ) ) {
...
abstract class com_greentiedev_wppf_abstract_view
extends com_greentiedev_phpCommon_abstractClass
implements com_greentiedev_wppf_interface_iView
{
	...
	final public function setTemplateEngine ( com_greentiedev_wppf_interface_iTemplateEngine $engine )
	{
	...
	final public function getTemplateEngine ()
	{
		...
		if ( $this->templateEngine == null ) {
			$this->setTemplateEngine( com_greentiedev_wppf_template_defaultEngine::getInstance() );
		}
