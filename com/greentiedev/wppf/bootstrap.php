...
if ( !class_exists( 'com_greentiedev_wppf_bootstrap' ) ) {

/**
 * @package       com.greentiedev.wppf
 * @title         bootstrap.php
...
abstract class com_greentiedev_wppf_bootstrap
extends com_greentiedev_phpCommon_abstractClass
{
	...
	protected function __construct ()
	{
		...
		$this->wppf_serviceFactory = new com_greentiedev_phpSpring_bean_factory_default( $sfXml, array(), $sfProps );
