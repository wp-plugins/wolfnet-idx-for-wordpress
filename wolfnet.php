 ...
 * Version:      2ad8b1541df556d2a9d702fd229d19dcb90d86a1
...
class Wolfnet
{
     ...
     * @var string
     */
    public $version = '2ad8b1541df556d2a9d702fd229d19dcb90d86a1';
    ...
    private function registerScripts()
    {
        $scripts = array(
            'migrate' => array(
                $this->url . 'js/jquery.migrate.min.js',
                array('jquery'),
                ),
            'tooltipjs' => array(
            ...
            'mousewheeljs' => array(
                $this->url . 'js/jquery.mousewheel.min.js',
                array('jquery'),
                ),
            'smooth-div-scroll' => array(
                $this->url . 'js/jquery.smoothDivScroll-1.2.min.js',
            ...
            'wolfnet-property-list' => array(
                $this->url . 'js/jquery.wolfnetPropertyList.min.js',
                array('jquery', 'wolfnet'),
                ),
